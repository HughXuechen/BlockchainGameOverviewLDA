...
% bluestNumber10ModelArray = [78  64  152  30  29  169  55  161  47  131]
% bluestNumber15ModelArray= [57  121  54  44  63  14  31  45  19  32  49  21  181  156  29]
% bluestNumber20ModelArray= [48  35  12  45  8  51  19  11  12  34  32  201  48  16  25  75  4  18  180  42]
...
for numTopicsFDS = 5:5:40
    ...
    writematrix(TopWordsEachTopic,TopWordsName)
            ...
            reprensentativeEachTopicTable=[reprensentativeEachTopicTable;["Topic",i," "," "]]
                ...
                [TopEachColumn,Index]=maxk(column,20);
